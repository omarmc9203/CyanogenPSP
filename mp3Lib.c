...
static void MP3Callback(void *_buf2, unsigned int numSamples, void *pdata)
{
	...
	{
		if (samplesInOutput > 0) // printf("%d samples in buffer\n", samplesInOutput);
		{
...
{ 
    ...
    sprintf(TmpID3.ID3Title,"Untitled"); 
    sprintf(TmpID3.ID3Artist,"Untitled"); 
    sprintf(TmpID3.ID3Album,"Untitled"); 
    sprintf(TmpID3.ID3Year,"Untitled"); 
    sprintf(TmpID3.ID3Comment,"Untitled"); 
    sprintf(TmpID3.ID3GenreCode,"Untitled"); 
    sprintf(TmpID3.ID3GenreText,"Untitled"); 
